...
Compensation and retries live in the workflow or the goal, not inside the noun, unless the noun’s adjective itself requires idempotency of a verb. Verbs must be safe to retry if the workflow retries them. Declare that on the verb.
