#!/usr/bin/env python3
"""Known-fail fixture gate for C15 v1."""
...
def main() -> int:
    ...
    if not any(v[1] == "apply_payment" for v in violations):
        print("ASSERT:FAIL expected apply_payment")
        return 1
    print("ASSERT:PASS fixture still fails C15 v1")
    return 0
