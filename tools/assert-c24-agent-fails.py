#!/usr/bin/env python3
"""Known-fail: the confirmer signed Ratified-by for the human."""
...
FIXTURE = ROOT / "examples" / "agent-ratified"
...
def main() -> int:
    ...
    if not any(v[1] == "agent-ratified" for v in violations):
        print("ASSERT:FAIL expected agent-ratified")
        return 1
    print("ASSERT:PASS fixture still fails C24 (agent-ratified)")
    return 0
