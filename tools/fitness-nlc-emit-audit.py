#!/usr/bin/env python3
"""Invoice-correct: ok specimen MET; missing-audit specimen stays red."""
...
def main() -> int:
    ...
    bad_code, bad_out = run(ROOT / "examples" / "emit-manifest-missing-audit")
    if bad_code == 0 or "RESULT:NOT_MET" not in bad_out:
        violations.append("missing-audit specimen did not stay red")
