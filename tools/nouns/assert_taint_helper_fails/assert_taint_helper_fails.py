"""Known-fail: taint returned through a same-file helper."""
...
FIXTURE = ROOT / "examples" / "card-taint-helper"
...
def main() -> int:
    ...
    if not any("return-taint" in v[2] for v in violations):
        print("ASSERT:FAIL expected return-taint through helper")
        return 1
    print("ASSERT:PASS fixture still fails R32 (helper taint)")
    return 0
