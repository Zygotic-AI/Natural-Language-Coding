"""Known-fail: key passed at the call, unused in the verb."""
...
FIXTURE = ROOT / "examples" / "retrying-key-unused"
...
def main() -> int:
    ...
    if not any(v[1] == "key-unused" for v in violations):
        print("ASSERT:FAIL expected key-unused")
        return 1
    print("ASSERT:PASS fixture still fails C15 (key unused)")
    return 0
