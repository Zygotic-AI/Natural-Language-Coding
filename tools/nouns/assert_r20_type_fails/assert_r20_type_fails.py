"""Known-fail: schema integer vs code str."""
...
FIXTURE = ROOT / "examples" / "schema-type-mismatch"
...
def main() -> int:
    ...
    if not any(v[2] == "type-mismatch" and v[3] == "amount" for v in violations):
        print("ASSERT:FAIL expected type-mismatch amount")
        return 1
    print("ASSERT:PASS fixture still fails R20 (type-mismatch)")
    return 0
