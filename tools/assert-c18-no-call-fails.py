...
FIXTURE = ROOT / "examples" / "goal-test-no-call"
...
def main() -> int:
    ...
    if not any(v[1] == "goal-test-no-call" for v in violations):
        print("ASSERT:FAIL expected goal-test-no-call")
        return 1
    print("ASSERT:PASS fixture still fails C18 (no call)")
    return 0
