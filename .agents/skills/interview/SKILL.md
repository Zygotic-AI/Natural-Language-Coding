...
SSOT: [`docs/ai-compiled-systems/PROCESS.md`](../../../docs/ai-compiled-systems/PROCESS.md) § Interview; [`INTENT-SURFACE.md`](../../../docs/ai-compiled-systems/INTENT-SURFACE.md).
...
| Knowledge domains | yes | Shelf consulted (`knowledge-steward` `load-shelf` / `flag-gap`); gaps closed or `Assumption:` |
...
3. Call **knowledge-steward** [`load-shelf`](../../../agents/knowledge-steward/AGENT.md) / `flag-gap`; new facts via `propose-fact` (human accepts).
