...
| 2 | Plan | Items are not goal / boundary / requirement / ADR work |
| 3 | Product statements | A step needs more than one boundary |
| 4 | Bind | Any statement lacks requirement ids, ADR ids, or explicit unbound handling |
...
1. **Machine gate** — at least check 1 (no goal writes noun fields). Non-zero exit = fail.
