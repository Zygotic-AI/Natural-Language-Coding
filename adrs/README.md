...
| [`0028-closed-atomic-verb-set-and-policy-adr-lineage.md`](0028-closed-atomic-verb-set-and-policy-adr-lineage.md) | Closed atomic verb set; policies compile to ADR lineages (tip-is-active) | Accepted |
