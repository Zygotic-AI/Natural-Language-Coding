...
The compiler is AI. That does not mean “autocomplete in a file.” It means: humans keep intent; AI emits a system; a gate fails a quiet fork.
...
A healthy system is not “more generated files.” It is: one home per adjective, every goal talking to that home through a contract, and a machine check that fails when that is not true.
